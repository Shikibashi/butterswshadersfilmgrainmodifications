...
#define Strength 35. // default is 16
#define Curve01 0.00125 // default is 0.25
#define Show_Grain 0
...
float4 main(float2 tex: TEXCOORD0): COLOR {
  ...
  float grain;
    ...
    return 0.5 + grain;
  #endif
  grain = 0.250*noiseStrength -dot(r_in, 0.0625*noiseStrength); // noiseStrength*grain // default is grain = 0.25*noiseStrength -dot(r_in, 0.125*noiseStrength);
