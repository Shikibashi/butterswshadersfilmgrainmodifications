...
#define Curve01 0 // Original: 0.25, Adjusted for more midtone concentration
#define Show_Grain 0
...
#define n 16 //number of randomization iterations, ex:4, ! a lower RunCount will cause patterned noise.
